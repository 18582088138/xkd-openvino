...
struct BallQueryBase : public ImplementationManager {
    explicit BallQueryBase(shape_types shape_type, ValidateFunc vf = nullptr) : ImplementationManager(impl_types::ocl, shape_type, std::move(vf)) {}
