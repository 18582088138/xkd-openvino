...
struct FurthestPointSamplingOptV3 : public FurthestPointSamplingBase {
    OV_GPU_PRIMITIVE_IMPL("ocl::furthest_point_sampling::opt_v3")
    explicit FurthestPointSamplingOptV3(shape_types shape_type, ValidateFunc vf = nullptr) : FurthestPointSamplingBase(shape_type, std::move(vf)) {}
