...
struct GroupingOperationBase : public ImplementationManager {
    explicit GroupingOperationBase(shape_types shape_type, ValidateFunc vf = nullptr) : ImplementationManager(impl_types::ocl, shape_type, std::move(vf)) {}
