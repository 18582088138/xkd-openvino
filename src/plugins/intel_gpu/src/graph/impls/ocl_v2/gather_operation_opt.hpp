...
struct GatherOperationOpt : public GatherOperationBase {
    OV_GPU_PRIMITIVE_IMPL("ocl::gather_operation::opt")
    explicit GatherOperationOpt(shape_types shape_type, ValidateFunc vf = nullptr) : GatherOperationBase(shape_type, std::move(vf)) {}
