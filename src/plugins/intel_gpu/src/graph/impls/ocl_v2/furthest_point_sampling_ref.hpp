...
struct FurthestPointSamplingRef : public FurthestPointSamplingBase {
    OV_GPU_PRIMITIVE_IMPL("ocl::furthest_point_sampling::ref")
    explicit FurthestPointSamplingRef(shape_types shape_type, ValidateFunc vf = nullptr) : FurthestPointSamplingBase(shape_type, std::move(vf)) {}
