...
struct FurthestPointSamplingOpt : public FurthestPointSamplingBase {
    OV_GPU_PRIMITIVE_IMPL("ocl::furthest_point_sampling::opt")
    explicit FurthestPointSamplingOpt(shape_types shape_type, ValidateFunc vf = nullptr) : FurthestPointSamplingBase(shape_type, std::move(vf)) {}
